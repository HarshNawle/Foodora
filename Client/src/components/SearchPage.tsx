          ...
          <div>
            ...
            <div className="flex flex-col my-3 gap-3 md:flex-row md:items-center md:gap-2">
                ...
                <div className="flex flex-wrap gap-2 mb-4 md:mb-0">
                    {
                        ["Biryani","Momos","Pizza"].map((selectedFilter:string, idx:number) => (
                            <div key={idx} 
                            className="relative inline-flex items-center max-w-full">
                                <Badge variant={"outline"} className="rounded-md cursor-pointer pr-6">{selectedFilter}</Badge>
                                <X
                                size={16}
            ...
            <div className="grid md:grid-cols-3 gap-4">
                <Card className=" dark:bg-gray-800 bg-white shadow-xl rounded-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                    ...
                    <CardContent className="p-4">
                        ...
                        <div className="mt-2 flex items-center gap-1 text-gray-600 dark:text-gray-400">
                            <MapPin size={16}/>
                            <p>City:{' '}
                                <span className="font-medium">Chandrapur</span>
                            </p>
                        </div>
                        <div className="mt-2 flex items-center gap-1 text-gray-600 dark:text-gray-400">
                            <MapPin size={16}/>
